...
public class Account_Details {
    ...
    @Size(min = 10,message = "please Enter valid PanCard Number")
    private String Pan_No;

    @Column(name = "Aadhaar_No",nullable = false)
   @Digits(integer = 12, fraction = 0,message = "Please Enter Valid AadhaarCard No")
    ...
    public Account_Details(String name, String address, String pan_No, long aadhaar_No, Double amount) {
        this.name = name;
